                ...
                <ul className='nav nav-tabs' id="myTab" role="tablist">
                  <li className='nav-item' role="presentation">
                    <a className={`nav-link ${activeTab === "visa" ? "active" : ""}`}
                      ...
                      onClick={() => handleTabChange("visa")} href="#visa"><img src="https://i.imgur.com/sB4jftM.png" alt="" width="80" />
                    </a>
                  </li>
                  <li className='nav-item' role="presentation">
                  ...
                  <div className={`tab-pane fade ${activeTab === "visa" ? "show active" : ""}`}
                    ...
                    <div className='mt-4 mx-4' >
                      ...
                      <div className='form mt-3'>
                        ...
                        <div className='px-5 pay' onClick={handleOrderConfirm}>
                          <button className='btn btn-success btn-block'>Order Now</button>
                        </div>
                      </div>
                    </div>
                  </div>
