                      ...
                      <tr key={indx}>
                        ...
                        <td className='cat-quantity'>
                          <div className="cart-plus-minus">
                            ...
                            <input type="submit" className='cart-plus-minus-box' name="qtybutton" value={item.quantity} id="" />
            ...
            <div className="cart-bottom">
              <div className="cart-checkout-box">
                <form action="" className='coupon'>
                  <input className='card-page-input-submit' type="text" name="coupon" id="coupon" placeholder='Coupon Code ...' />
